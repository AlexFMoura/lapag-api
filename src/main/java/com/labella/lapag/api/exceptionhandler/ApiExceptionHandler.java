package com.labella.lapag.api.exceptionhandler;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        problemDetail.setType(URI.create("https://labellamakes.com/erros/campos-invalidos"));
    ...
    public ProblemDetail capturar(NegocioException e) {
        ...
        problemDetail.setType(URI.create("https://labellamakes.com/erros/regra-de-negocio"));
